...
def show_optimization(data, opt_state, hand_contact_target=None, obj_contact_target=None, is_video=False, label=None, vis_method=1, delay=0.001):
    ...
    if vis_method == 2 or vis_method == 3: # opt_state[-1]['contact_hand']/ opt_state[-1]['contact_obj'] real-time contact area
    ...
    hand_mesh_opt.vertices = o3du.Vector3dVector(opt_state[-1]['hand_verts'].squeeze()) # o3du.Vector3dVector: Vector calculation class
