...
class ContactDBDataset(Dataset):
    ...
    def __init__(self, data, train=False, min_num_cont=1):
        ...
        if 'num_verts_in_contact' in self.dataset[0]: # The key "num_verts_in_contact" exits in other datasets (like HO3D, DexYCB). ContactPose dose not have this key.
            ...
            # Cut grasps with less than this num_verts_in_contact of initial contact
    ...
    @staticmethod
    def collate_fn(batch): # Custom collate_fn function(organize data): organize batch_size samples into one batch sample for batch training.
        out = dict()
        ...
        # The default execution is to merge a (batch_size) set of samples into a tensor of (batch_size) size.
